...
//{
//    if([property.sqlColumnName isEqualToString:@"title"])
//    {
//        if(self.title == nil)
//            return @"";
...
//{
//    if([property.sqlColumnName isEqualToString:@"information"])
//    {
...
{
    //    if([property.sqlColumnName isEqualToString:@"region"])
    //    {
    //        property.defaultValue = @"2001";
    //    }
    //    else if([property.propertyName isEqualToString:@"type"])
    //    {
    //        // if you use unique,this property will also become the primary key
    //        //        property.isUnique = YES;
    //        property.defaultValue = @"1001";
    //        property.length = 30;
    //    }
}
