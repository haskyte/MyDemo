...
@interface VideoPlayerController ()<UINavigationBarDelegate>
...
@property (nonatomic) BOOL hiden;   // 是否隐藏状态栏
...
- (void)viewDidLoad {
    ...
    //http://192.168.2.240:8000/date/app/attachment/anchor/6/20170221/test.mp4
    // 创建AVPlayer
    self.playerItem = [AVPlayerItem playerItemWithURL:[NSURL URLWithString:@"http://vjs.zencdn.net/v/oceans.mp4"]];
    self.player = [AVPlayer playerWithPlayerItem:_playerItem];
    AVPlayerLayer *playerLayer = [AVPlayerLayer playerLayerWithPlayer:_player];
    playerLayer.frame = CGRectMake(0, 96, _width, _height - 192);
    ...
    self.topView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, _width, 64)];
    _topView.image = [UIImage imageNamed:@""];
...
- (void)createSlider
{
    self.slider = [[UISlider alloc]initWithFrame:CGRectMake(100, 741, 784, 15)];
    _slider.minimumTrackTintColor = [UIColor colorWithWhite:0.5 alpha:1];
...
- (void)createProgress
{
    self.progress = [[UIProgressView alloc]initWithFrame:CGRectMake(102, 748, 784, 15)];
    self.progress.tintColor = [UIColor colorWithWhite:0.5 alpha:1];
...
{
    self.currentTimeLabel = [[UILabel alloc]initWithFrame:CGRectMake(914, 738, 100, 20)];
...
- (void)createButton
{
    ...
    startButton.frame = CGRectMake(35, 733, 30, 30);
    [self.backView addSubview:startButton];
    if (_player.rate == 1.0) {
        
        [startButton setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
    } else {
        [startButton setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
...
//    nextButton.frame = CGRectMake(60, 745, 25, 25);
...
- (void)backButton
{
    ...
    button.frame = CGRectMake(15, 30, 55, 26);
    [button setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
